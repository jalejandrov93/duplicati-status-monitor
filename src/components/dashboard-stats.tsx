...
export function DashboardStats({ stats }: DashboardStatsProps) {
    ...
    return (
        <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4 z-10">
            {/* Total Machines */}
            <div className="flex items-center gap-3 rounded-xl bg-blue-100 dark:bg-blue-900/20 p-4 text-card-foreground shadow-sm">
            ...
            {/* Successful */}
            <div className="flex items-center gap-3 rounded-xl p-4 text-card-foreground bg-green-100 dark:bg-green-900/20 shadow-sm">
                <div className="shrink-0 p-2 rounded-lg ">
            ...
            {/* Warnings */}
            <div className="flex items-center gap-3 rounded-xl p-4 text-card-foreground bg-yellow-100 dark:bg-yellow-900/20 shadow-sm">
                <div className="shrink-0 p-2 rounded-lg ">
            ...
            {/* Errors */}
            <div className="flex items-center gap-3 rounded-xl p-4 text-card-foreground bg-red-100 dark:bg-red-900/20 shadow-sm">
                <div className="shrink-0 p-2 rounded-lg ">
